...
- Server CORS: set `FRONTEND_URL` to the deployed client URL, or use comma-separated `FRONTEND_URLS` for multiple client URLs. These values are read at runtime from Render.
